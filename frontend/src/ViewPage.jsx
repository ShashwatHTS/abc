...
const ViewPage = () => {
	...
	useEffect(() => {
		if (pairs.length > 0) {
			setName(pairs[currentIndex].name);
			setValue(pairs[currentIndex].value);
		}
	}, [pairs, currentIndex]);
					...
					<div className="flex flex-col items-center space-y-4">
						{edit ? (
							<div className="flex w-full justify-between p-8 rounded-lg">
								...
								<button
									onClick={() => handleEdit(pairs[currentIndex].id)}
							...
							<div className="flex w-full justify-between p-8 rounded-lg">
								...
								<div className='space-x-4'>
									...
									<button
										onClick={() => handleDelete(pairs[currentIndex].id)}
